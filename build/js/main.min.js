...
/* harmony import */ var _modules_mask_button__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/mask-button */ "./js/modules/mask-button.js");
/* harmony import */ var _modules_adaptive__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/adaptive */ "./js/modules/adaptive.js");
...
window.addEventListener('DOMContentLoaded', function () {
  var descriptionButtonOpen = document.querySelector('.company__button');
  function descriptionHeightToggle(event) {
    var descriptionButton = event.target;
    var description = descriptionButton.closest('.company__inner').querySelector('.company__description');
  ...
  Object(_modules_mask_button__WEBPACK_IMPORTED_MODULE_4__["maskPhone"])();

  // Utils
  // ---------------------------------

  Object(_modules_adaptive__WEBPACK_IMPORTED_MODULE_5__["breakpointCheckerDesktop"])();
    ...
    accordionTitles.forEach(function (accordeonTitle) {
      accordeonTitle.addEventListener('click', function (evt) {
        ...
        if (parent.classList.contains('is-open')) {
          ...
          var blocks = document.querySelectorAll('.accordion__item.is-open');
